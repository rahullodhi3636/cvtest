...
class FrontController extends Controller
{
    ...
    public function parallel_screen()
    {
        $user_id = Auth::user()->id;
        return view('front.parallel_front',compact('user_id'));
    }

    public function parallel_popupdata(Request $request){
        // $user_id = $request->user_id;
        // $destinationPath=public_path()."/src/public/parallel_data/".$user_id."_file.json";
        // $jsonString = file_get_contents($destinationPath);
        $jsonString = session('front_screen_data');
