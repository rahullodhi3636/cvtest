            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
                    ...
                    @endphp
                    <a href="{{ route('logout') }}" class="loginbtn text-center" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                      {{ __('Logout') }}
                    </a>
                    <br>
                    @php
                    ...
                    @endphp
                    <a href="{{ url('home') }}" class="loginbtn text-center">
                      {{ __('Back') }}
                    </a>
                    <br>
                    @php
                    ...
                    @endif
                <form class="" method="POST" action="{{ route('search_profile') }}" class="margin-bottom-0">
                  ...
                  <div  class="{{ $errors->has('rfid') ? ' has-error' : '' }}">
                    <span class="text-danger">@if ($errors->has('rfid')){{ $errors->first('rfid') }} @endif</span>
                    <div class="form-group">
                     <input id="rfid" type="text" class="form-control form-control-lg" name="rfid" placeholder="Enter RFID Here Or Mobile Number">
                    </div> 
                  </div>
                  <div>
