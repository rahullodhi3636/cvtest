            ...
            <div class="boxbody">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-12">
                        ...
                        <h5 class="card-title">New Combo <i class="fa fa-plus"></i></h5>
                        </div>
                    </div><!--./col-lg-6-->
                </div><!--./row-->
                ...
                <form id="addcomboForm" action="{{ route('addcomboservice') }}" method="post" class="formvisit mt-2">
                    <div class="row">
                    <div class="col-lg-4 col-md-12 col-12">
                        <div class="form-group">
                        <label>Combo Name</label>
                        <div class="input-group mb-3">
                            <input required type="text" id="combo_name" name="combo_name" class="form-control" placeholder="Enter Combo Name">
                        </div>
                        </div><!--./form-group-->
                    </div><!--./col-lg-8-->
                      <div class="col-lg-4 col-md-12 col-12">
                          <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                  <input required type="text" id="grand_total" name="grand_total" class="form-control" placeholder="Enter Grand Total">
                              </div>
                          </div><!--./form-group-->
                      </div><!--./col-lg-4-->
                    <div class="col-lg-4 col-md-12 col-12">
                        <div class="form-group">
                            <label>Price</label>
                            <div class="input-group mb-3">
                                <input required type="text" id="combo_price" name="combo_price" class="form-control" placeholder="Enter Combo Price">
                            </div>
                        </div><!--./form-group-->
                    </div><!--./col-lg-4-->
                    ...
                    <div class="row">
                        ...
                        <input type="submit" name="combo_with_service"  value="Save" class="btn btn-primary waves-effect waves-light">
                        </div>
                    </div>
                </form>
                </div><!--./col-lg-12-->
