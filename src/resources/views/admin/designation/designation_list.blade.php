      ...
      <div class="container-fluid">
         <div class="boxbody">
            <ul class="nav nav-tabs2 nav-justified">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#Customer">Designation</a>
              </li>
              <!-- <li class="nav-item">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="Customer">
                ...
                <div class="panelbox">
                  <div class="text-right mt-2 mb-2"><a data-toggle="modal" data-target="#addfirm" href="javascript:void(0)" class="theme-btn">New Designation</a></div>
                  <div class="row">

                   <div class="col-lg-12 col-md-12 col-12 mt-3">
                     <h6><i class="fa fa-tasks"></i> Designation Count <span id="customerCount"><?php echo count($designation) ?></span></h6>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Enter Designation "  class="form-control">
                  </div>
                </div><!--./col-lg-4-->
...
<script type="text/javascript">
  ...
  function getDesignation(locaid) {
    if (locaid != '') {
      $.ajax({
