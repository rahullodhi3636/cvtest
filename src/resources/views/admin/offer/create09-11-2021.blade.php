                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-4 col-md-12 col-12">
                          <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                  <select name="Offer_party" id="Offer_party" class="form-control" >
                    ...
                    <div class="row" id="discount_on_plan" style="display:none;">
                      ...
                      <div class="col-lg-6 col-md-12 col-12" >
                            ...
                            <label>Discount on service</label>
                                <div class="input-group mb-3">
                                  <input type="text" id="Offer_discount" name="Offer_discount" class="form-control" placeholder="Enter Offer discount">
                                </div>
                            </div><!--./form-group-->
                      </div><!--./col-lg-4-->
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-12 col-12">
                          <div class="form-group">
                              <label>Referral Price</label>
                              <div class="input-group mb-3">
                                <input required type="text" id="Offer_price" name="Offer_price" class="form-control" placeholder="Enter Offer price">
                              </div>
                          </div><!--./form-group-->
                      </div><!--./col-lg-6-->
                    </div>
                    <div class="row">
                      <div class="col-lg-6 col-md-12 col-12">
                          <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                <input required type="text" id="description" name="description" class="form-control" placeholder="Enter Offer Description">
                              </div>
                          </div><!--./form-group-->
                      </div><!--./col-lg-6-->
                    </div>
