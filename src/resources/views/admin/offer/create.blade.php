            ...
            <div class="boxbody">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-12">
                        ...
                        <h5 class="card-title">New Referral <i class="fa fa-plus"></i></h5>
                        </div>
                    </div><!--./col-lg-6-->
                </div><!--./row-->
                ...
                <form id="addOfferForm" action="{{route('offers.store')}}" method="post" class="formvisit mt-2">
                  ...
                  <div class="row">
                      <div class="col-lg-4 col-md-12 col-12">
                          ...
                          <div class="input-group mb-3">
                              <input required type="text" id="Offer_name" name="Offer_name" class="form-control" placeholder="Enter Offer Name">
                          </div>
                          </div><!--./form-group-->
                      </div><!--./col-lg-8-->
                      ...
                      <div class="col-lg-4 col-md-12 col-12">
                        ...
                        <div class="input-group mb-3">
                            <input required type="text" id="code_prefix" name="code_prefix" class="form-control" placeholder="Enter code prefix">
                        </div>
                        </div><!--./form-group-->
                    </div><!--./col-lg-8-->

                    </div><!--./row-->
                    <div class="row" id="referred_div">
                           <div class="col-lg-12 col-md-12 col-12">
                                <h4>Referred</h4>
                    ...
                    <div class="row" id="membership_div" style="display: none">
                        <div class="col-lg-12 col-md-12 col-12" >
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="membership_id" id="membership_id" class="form-control">
                                        ...
                                        @foreach ($Member_Systems as $mvalue)
                                            <option value="{{ $mvalue->id}}">{{ $mvalue->membership_name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                    ...
                    <div class="row">
                       ...
                       <div class="col-lg-6 col-md-12 col-12">
                          <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                <input required type="text" id="Offer_price" name="Offer_price" class="form-control" placeholder="Enter wallet balance">
                              </div>
                          </div><!--./form-group-->
                      </div><!--./col-lg-6-->
                      ...
                      <div class="col-lg-6 col-md-12 col-12">
                          {{-- <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                <input required type="text" id="Offer_validity" name="Offer_validity" class="form-control" placeholder="Enter Offer Validity">
                              </div>
                          </div> --}}
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                            <input name="offer_from" id="offer_from" type="text" class="form-control datepicker" placeholder="">
                            ...
                            <input name="offer_to" id="offer_to" type="text" class="form-control datepicker" placeholder="">
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                            </div>
                          </div>
