                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="dash_boxcontainner white_boxlist">
                            ...
                            @endif
                            <div class="col-md-12">
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('packages.store') }}" method = "post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="text"  id="title" name="title" value="{{ old('name') }}" placeholder="Enter package title"  class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <!-- <div class="col-md-12 col-sm-12 col-xs-12">
                                    <select class="form-control selectpicker col-md-7 col-xs-12" id="services" data-live-search="true" data-hide-disabled="true" data-actions-box="true" multiple>
                                      <option value="">Select</option>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="number"  id="price" name="price" value="{{ old('price') }}" placeholder="Enter package price"  class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="number"  id="duration" name="duration" value="{{ old('duration') }}" placeholder="Enter package duration"  class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <select name="packagetype" class="form-control col-md-7 col-xs-12" id="packagetype">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('packagetype') == '1'? 'selected' : '' }} >Premium</option>
                                        <option value="0" {{ old('packagetype') == '0' ? 'selected' : '' }}>Normal</option>
                                    </select>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="number"  id="members" name="members" value="{{ old('members') }}" placeholder="Enter package members"  class="form-control col-md-7 col-xs-12">
