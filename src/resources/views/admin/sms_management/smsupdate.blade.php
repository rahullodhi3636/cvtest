                    ...
                    <div class="col-md-12">
                        <div class="dash_boxcontainner white_boxlist">
                            <div class="upper_basic_heading">
                                <span class="white_dash_head_txt">Edit SMS Template <a href="{{ url('admin/sms') }}" class="btn margin0 btn-sm btn-mdb-color single-table-btn float-right waves-effect waves-light" ><i class="mdi mdi-arrow-left mr-1"></i>Back</a> </span>
                            </div>
                            ...
                            @endif
                            <div class="col-md-12">
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('sms.update',$sms->id) }}" method = "post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="text"  id="name" name="name" value="{{ old('name',$sms->template_name) }}" placeholder="Enter template name"  class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <textarea id="message" name="message" placeholder="Enter template message"  class="form-control col-md-7 col-xs-12">{{ old('message',$sms->template_message) }}</textarea>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <select name="status" class="form-control col-md-7 col-xs-12" id="status">
                                        <option value="1" {{ old('status',$sms->template_status) == '1'? 'selected' : '' }} >Active</option>
                                        <option value="0" {{ old('status',$sms->template_status) == '0' ? 'selected' : '' }}>Deactive</option>
                                    </select>
