                    ...
                    <div class="col-md-12">
                        <div class="dash_boxcontainner white_boxlist">
                            <div class="upper_basic_heading">
                                <span class="white_dash_head_txt">Edit Enquiry <a href="{{ url('admin/customer') }}" class="btn margin0 btn-sm btn-mdb-color single-table-btn float-right waves-effect waves-light" ><i class="mdi mdi-arrow-left mr-1"></i>Back</a> </span>
                            </div>
                            ...
                            @endif
                            <div class="col-md-12">
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('customer.update', $customer->id) }}" method = "post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <img src="{{ url('images/customer') }}/{{$customer->customer_image}}" width="100px">
                                    @endif
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="customer_id">User Id <span class="required">*</span> </label>
                                        <input type="text"  id="customer_id" name="customer_id" value="{{ old('customer_id',$customer->customer_id) }}" placeholder="Enter User Id"  class="form-control" autocomplete="off" readonly="true">
                                        ...
                                        <select name="package_id" class="form-control" onchange="getservices(this.value);">
                                            ...
                                            @if(!empty($packages))
                                              @foreach($packages as $Key => $value)
                                                <option value="{{ $value->package_id }}"  {{ old('package_id',$customer->package_id) == $value->package_id ? 'selected' : '' }}>{{ $value->package_title }}</option>
                                              @endforeach 
                                            @endif
                                        </select>
                                  ...
                                  <div class="form-group">
                                    <label class="control-label" for="cust_type">Customer Type </label>
                                        <select name="cust_type" class="form-control">
                                            <option value="">--select--</option>
                                            <option value="VIP"  {{ old('cust_type',$customer->cust_type) == 'VIP' ? 'selected' : '' }}>VIP</option>
                                            <option value="NON VIP"  {{ old('cust_type',$customer->cust_type) == 'NON VIP' ? 'selected' : '' }}>NON VIP</option>
                                        </select>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="name">Name <span class="required">*</span> </label>
                                        <input type="text"  id="name" name="name" value="{{ old('name',$customer->name) }}" placeholder="Enter name"  class="form-control" autocomplete="off">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="name">Location <span class="required">*</span> </label>
                                        <input type="text"  id="location" name="location" value="{{ old('location',$customer->location) }}" placeholder="Enter location"  class="form-control" autocomplete="off">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="contact">Contact <span class="required">*</span> </label>
                                        <input type="text"  id="contact" name="contact" value="{{ old('contact',$customer->contact) }}" placeholder="Enter contact"  class="form-control" autocomplete="off">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="other_contact">Other Contact </label>
                                        <input type="text"  id="other_contact" name="other_contact" value="{{ old('other_contact',$customer->other_contact) }}" placeholder="Enter other contact"  class="form-control" autocomplete="off">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="email">Email </label>
                                        <input type="text"  id="email" name="email" value="{{ old('email',$customer->email) }}" placeholder="Enter email"  class="form-control" autocomplete="off">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="contact">Dob </label>
                                        <input type="text"  id="dob" name="dob" value="{{ old('dob',$customer->dob) }}" placeholder="Enter dob"  class="form-control datepicker" data-date-format="yyyy-mm-dd" autocomplete="off">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="referral_code">Referral Code  </label>
                                        <input type="text"  id="referral_code" name="referral_code" value="{{ old('referral_code',$customer->referral_code) }}" placeholder="Enter referral code"  class="form-control" autocomplete="off">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="referred_by">Referred By  </label>
                                        <input type="text"  id="referred_by" name="referred_by" value="{{ old('referred_by',$customer->referred_by) }}" placeholder="Enter Referred By"  class="form-control" autocomplete="off">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="control-label" for="reward_points">Reward Points  </label>
                                        <input type="text"  id="reward_points" name="reward_points" value="{{ old('reward_points',$customer->reward_points) }}" placeholder="Enter reward points"  class="form-control" autocomplete="off">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="control-label" for="anniversary_date">Anniversary Date</label>
                                        <input type="text"  id="anniversary_date" name="anniversary_date" value="{{ old('anniversary_date',$customer->anniversary_date) }}" placeholder="Enter anniversary date"  class="form-control datepicker" data-date-format="yyyy-mm-dd" autocomplete="off">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="control-label" for="rf_id">RF-ID Code <span class="required">*</span> </label>
                                        <input type="text"  id="rf_id" name="rf_id" value="{{ old('rf_id',$customer->rf_id) }}" placeholder="Enter rf id"  class="form-control" autocomplete="off">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <textarea id="remark" name="remark" placeholder="Enter remark"  class="form-control">{{ old('remark',$customer->remark) }}</textarea>
