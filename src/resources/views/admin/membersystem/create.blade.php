            ...
            <div class="boxbody">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-12">
                        ...
                        <h5 class="card-title">New Membership <i class="fa fa-plus"></i></h5>
                        </div>
                    </div><!--./col-lg-6-->
                </div><!--./row-->
                ...
                <form id="addcomboForm" action="{{route('MemberSystem.store')}}" method="post" class="formvisit mt-2">
                  ...
                  <div class="row">
                      <div class="col-lg-6 col-md-12 col-12">
                          ...
                          <div class="input-group mb-3">
                              <input required type="text" id="membership_name" name="membership_name" class="form-control" placeholder="Enter Membership Name">
                          </div>
                          </div><!--./form-group-->
                      </div><!--./col-lg-8-->
                      <div class="col-lg-6 col-md-12 col-12">
                          <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                  <select name="membership_type" id="membership_type" class="form-control" onchange="getPlanCatgeory(this.value)">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-12 col-12" id="addservice" style="display:none">
                            <div class="form-group">
                            <!-- <label>.</label> -->
                                <div class="input-group mb-3">
                    ...
                    <div class="row" id="discount_on_plan" style="display:none;">
                      ...
                      <div class="col-lg-6 col-md-12 col-12" >
                            ...
                            <label>Discount on service</label>
                                <div class="input-group mb-3">
                                  <input type="text" id="membership_discount" name="membership_discount" class="form-control" placeholder="Enter Membership discount">
                                </div>
                            </div><!--./form-group-->
                      </div><!--./col-lg-4-->
                      <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                            <label>Minimum Required Amt</label>
                                <div class="input-group mb-3">
                                  <input type="text" id="minimum_req_amt" name="minimum_req_amt" class="form-control" placeholder="Enter Minimum Required Amount">
                                </div>
                            </div><!--./form-group-->
                      </div><!--./col-lg-4-->
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-6 col-md-12 col-12">
                          <div class="form-group">
                              <label>Membership Validity (Total Days)</label>
                              <div class="input-group mb-3">
                                <input required type="text" id="membership_validity" name="membership_validity" class="form-control" placeholder="Enter Membership Validity">
                              </div>
                          </div><!--./form-group-->
                      </div><!--./col-lg-6-->
                      <div class="col-lg-6 col-md-12 col-12">
                          <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                <input required type="text" id="membership_price" name="membership_price" class="form-control" placeholder="Enter Membership price">
                              </div>
                          </div><!--./form-group-->
                      </div><!--./col-lg-6-->
                    </div>
...
<script>
    ...
    function calcualte_plan_price(){
      ...
      $('.countTotal').each(function() {
        ...
        $("#membership_price").val(parseFloat(subtotal).toFixed(2));
      });
    }
