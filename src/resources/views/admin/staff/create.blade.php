            ...
            <div class="boxbody">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-12">
                        ...
                        <h5 class="card-title">New Staff <i class="fa fa-plus"></i></h5>
                        </div>
                    </div><!--./col-lg-6-->
                </div><!--./row-->
                ...
                <form id="addStaffForm" action="{{ route('staff.store') }}" method="post" class="formvisit mt-2">
                   @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if(!empty($roles))
                                    ...
                                    @endphp
                                    <option value="{{$role->role_id }}" {{(old("role") == $id_role ? "selected":"") }}>{{$role->role_name}}</option>
                                    @endforeach
                                @endif
                                </select>
                                <span class="text text-danger">@if ($errors->has('branch')){{ $errors->first('branch') }} @endif</span>
                ...
                <div class="row">
                    ...
                    <input type="submit" name="Staff_with_service"  value="Save" class="btn btn-success">
                    </div>
                </div>
                </form>
                </div><!--./col-lg-12-->
