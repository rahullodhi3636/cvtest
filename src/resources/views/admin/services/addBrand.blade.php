      ...
      <div class="container-fluid">
         <div class="boxbody">
            <ul class="nav nav-tabs2 nav-justified">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#Customer">Brand</a>
              </li>
              <!-- <li class="nav-item">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="Customer">
                ...
                <div class="panelbox">
                  ...
                  <div class="text-right mt-2 mb-2"><a href="#"  onclick="addBrand('{{ $serviceid }}','{{ $subid }}')" class="theme-btn">Add Brand</a></div>
                  ...
                  <div class="row">
                   ...
                   <div class="col-lg-12 col-md-12 col-12 mt-3">
                     <h6><i class="fa fa-tasks"></i> Service Name : <span id="customerCount"><?php echo $service; ?></span> || Category Name : <span id="customerCount"><?php echo $category; ?></span></h6>
                        ...
                        <?php if (!empty($subcat)): ?>
                          ...
                          ?>
                                <tr>
                                    ...
                                    <td>
                                        <i class="fa fa-edit text-info" onclick="getGroup('<?php echo $sub->id; ?>')"></i> |
                                        <i class="fa fa-trash text-danger" onclick="deleteBrand('<?php echo $sub->id; ?>')"></i> |
                                        <a class="btn btn-sm btn-info" href="{{url('admin/addBrandRand/')}}<?php echo '/'. $sub->service_id;?>/<?php echo  $sub->sub_category_id;?>/<?php echo $sub->id;?>">Add Range</a>
                                        {{-- / --}}
                                    </td>
                                </tr>
    ...
    if (groupid != '') {
      $.ajax({
        ...
        success:function(res) {
          ...
          $("#brand_description").val(res.brand_description);
        }
      });
    }
  }
