                        ...
                        <?php if (!empty($groups)): ?>
                          ...
                          ?>
                                <tr>
                                    ...
                                    <td>
                                        <i class="fa fa-edit text-info" onclick="getGroup('<?php echo $group->id; ?>')"></i> |
                                        <i class="fa fa-trash text-danger" onclick="deleteService('<?php echo $group->id; ?>')"></i> |
                                        <a class="btn btn-sm btn-info" href="subService/<?php echo $group->id;?>/<?php echo $group->firm_id;?>">Sub Service</a>
