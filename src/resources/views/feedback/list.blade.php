 ...
 <div class="main">
    ...
    <script>
        ...
        function getRatingDetails() {
            $('#reportbody').html('');  
            let result_row='';
            let rating=($('#rating_id').val())?$('#rating_id').val():'';
                        ...
                        if(res.data.length>0){
                            res.data.forEach((element,index) => {
                                result_row=`<tr>
                                                ...
                                                <td><img src="<?php echo asset('src/public/images/star/${element.rating}.png')?>" style="width:150px"></td>
                            ...
                            alert('No data found in this rating');
                        }
                    },
