                  ...
                  <div class="input-group mb-3">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                      ...
                      <div class="col-lg-6 col-md-12 col-12 text-right">
                        ...
                        <input type="submit"  id="save_form"  style="display:none;">
                      </div><!--./col-lg-4-->
                    </div><!--./row-->
                  </div><!--/col-lg-12-->
                </div><!--./row-->
              ...
              var res = result.row;
                    ...
                    $.each(res, function (i, item) {
                        ...
                        html+=`<a class="btn btn-link" data-toggle="collapse" data-target="#collapse${i}" aria-expanded="true" aria-controls="collapse${i}">
                                ${item.firm_name} &nbsp;<span class="save_firm_text_${item.firm_id}"></span>
                              </a>`;
                        html+=`</h5>`;
                        html+=`</div>`;
                        if(i==0){
                        ...
                        services += '<tr><td class="emptyrow" colspan="4"><strong>Subtotal </strong></td><td class="emptyrow"></td><td class="emptyrow"><i class="fa fa-inr"></i>'+item.subtotalamount+'</td></tr>';
                        services += '<tr><td class="emptyrow" colspan="4"><strong>Total </strong></td><td class="emptyrow"></td><td class="emptyrow"><i class="fa fa-inr"></i>'+item.total_amount+'</td></tr>';
                        services += '</tbody>';
                        services += '</table>';
                        html += services;
                        html += '</div>';
