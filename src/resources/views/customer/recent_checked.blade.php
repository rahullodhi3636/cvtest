...
@section('content')
 <div class="main">
    ...
    <!-- The Modal -->
    <div class="modal" id="addLocation" style="z-index: 2000;">
       ...
       <!--add designation form--->
        <div class="modal" id="addDesignation" style="z-index: 2000;">
          <div class="modal-dialog modal-mld">
...
<div class="modal" id="saveotpModelsssssss">
   ...
   <div class="modal" id="addcustomer">
      <div class="modal-dialog modal-lg">
        <form id="addcustomerform" enctype="multipart/form-data">
          <div class="modal-content">
            ...
            <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
            <input type = "hidden" name = "apply_checkin" id="apply_checkin">
            <!-- Modal body -->
            <div class="modal-body formvisit">
              <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select type="text"  id="exist_location" name="location" value="{{ old('location') }}" placeholder="Enter location"  class="form-control" autocomplete="off">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="control-label" for="contact">Contact <span class="required">*</span>  <button class="btn btn-danger" id="otpbtn"  type="button" onclick="sendotp()">Get OTP</button></label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select type="text"  id="designation" name="designation" value="{{ old('designation') }}"   class="form-control" autocomplete="off">
                    <option value="">Select Location</option>
    ...
    <div class="modal" id="checkin_customer">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label">Do you want to check in customer </label>
                        <input type="radio" name="apply_check_in" value="1" checked>Yes
                        <input type="radio" name="apply_check_in" value="0">No
                    </div>
                  </div>
              ...
              <div class="modal-footer">
                 <button  onclick="apply_checkin();" class="theme-btn">Apply</button>
              </div>
            </div>
...
function apply_checkin(){
    var checkin = $("input[name='apply_check_in']:checked").val();
    $('#apply_checkin').val(checkin);
                    ...
                    success:function(res) {
                        ...
                        if(res != "" && res != null){
                          ...
                          if(checkinstatus==0){
                            ...
                            status_td=`<button type="button" class="theme-btn mt-2" onclick="CheckoutStatus(${res.id})">CheckOut</button>`;
                          }
                          new_row=`<tr>
                            <td class="td-sm">1</td>
        ...
        function CheckoutStatus(cust_id){
          ...
          if(cust_id!="")
          {
            $.ajax({
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                alert('Something went wrong in checkout status');
                }
              });
          }
        }
