                  ...
                  <div class="col-lg-4 col-md-12 col-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input type="hidden" name="save_firm_id" id="save_firm_id"  >
                        <input type="hidden" name="extra_discount" id="extra_discount"  >
                        <input type="hidden" name="bridal_pack" id="bridal_pack"  value="0">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                      ...
                      <div class="col-lg-6 col-md-12 col-12 text-right">
                        ...
                        <button type="button" onclick="get_invoice_type(),checkcustomer_id();" class="btn btn-success btn-sm waves-effect waves-light" id="continue_btn"> Continue</button>
                        <input type="submit"  id="save_form"  style="display:none;" value="save">
                      </div><!--./col-lg-4-->
                    </div><!--./row-->
                  </div><!--/col-lg-12-->
                </div><!--./row-->
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="saved_invoice_id"></div>
                        ...
                        <div class="modal-footer">
                          ...
                          <a type="button" class="btn btn-primary" href="{{ url('quick_sale') }}">New Invoice</a>
            ...
            <div class="modal-content">
              ...
              <form class="formvisit mt-2" id="other_service_details">
                <div class="modal-body">
                  ...
                  <input type = "hidden" name = "other_cate_id" id="other_cate_id">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="other_brand_description" id="other_brand_description" onblur="calculate_sitpack_installment()">
                            </div>
                          </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              <label for="">Enter Sub service Name</label>
                              <input type="text" class="form-control" name="other_subservice_name" id="other_subservice_name">
                            </div>
                          </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script type="text/javascript">
  ...
  function calculatecash() {
    ...
    $('.compositionCount').each(function(){
        totalcomposition += parseFloat(this.value);  // Or this.innerHTML, this.innerText
          $("#totalcompositionval").html(parseFloat(totalcomposition).toFixed(2));
          $("#totalinputComposition").val(parseFloat(totalcomposition).toFixed(2));
        });
    ...
    function discByPercent(disc) {
      ...
      $('.countTotal').each(function() {
        ...
        $('.totalprice').each(function(){
            ...
            $("#extra_discount").val(totaldiscount1);
        });
    ...
    function addServiceRow(argument) {
      ...
      html +='<input type="hidden" name="service['+rowcount+'][offer_id]" id="offer_id_'+$(".servicerow").length+'" value="0">';
      html +='<input type="hidden" name="service['+rowcount+'][free_service]" id="free_service_'+$(".servicerow").length+'" value="0">';
      ...
      html +='<input value="" type="hidden" name="service['+rowcount+'][firm_id]" id="firm_id_'+rowcount+'">';
      html +='<select title="Select" required name="service['+rowcount+'][servicegroups]" id="servicegroups_'+$(".servicerow").length+'" class="form-control " onchange="getServices(this.value,'+$(".servicerow").length+')" data-live-search="true">';
      ...
      html +='</div>';
      html +='<input class="form-control" name="service['+rowcount+'][serviceName]" id="serviceName'+$(".servicerow").length+'" required >';
      html +='</div>';
      html += '</div>';
      html +='</div>';
      html +='<div class="col-lg-2 col-md-12 col-12">';
      ...
      html +='<input name="service['+rowcount+'][servicesComposition]" type="hidden" id="servicesComposition'+$(".servicerow").length+'" class="compositionCount">';
      ...
      html +='<div class="col-lg-2 col-md-6 col-12">';
      html +='<div class="form-group">';
      html +='<label style="font-size:11px">Cgst/Sgst/Disc%/Comp%</label>';
      ...
      html +='<div class="text-center" id="spinner_service" style="display:none">';
      ...
      if(array[i] != ""){
        $.ajax({
          ...
          success:function(res) {
            ...
            $("#firm_id_"+totalcount).val(res.firm_id);
            ...
            var composition_persent = 0;
            if(res.composition_status==1){
                 composition_persent = res.composition;
            }

            var cgstvalue = cgst+'/'+sgst+'/'+gstdiscount+'/'+composition_persent;
    ...
    function showServiceBrands(service_id) {
      ...
      else if((service_id != "")&&(service_id==0))
      {
        ...
        var category_id=$('#firmServie_'+totalcount).val();
        $("#serviceBrandDiv_"+totalcount).html('');
        $('#other_service_id').val(other_service_id);
        $('#other_cate_id').val(category_id);
        // servicegroups_
    ...
    function addDiscount(count) {
      ...
      if (add_disc==0) {
        ...
        $("#servicesSgst"+count).val(parseFloat(totalsgst).toFixed(2));
        $("#servicesCgst"+count).val(parseFloat(totalcgst).toFixed(2));
        $("#servicesComposition"+count).val(parseFloat(composition).toFixed(2));
  ...
  <script>
    function get_invoice_type(firm_id=""){
      // $("#addfirm").modal('hide');
            ...
            success: function(result){
              ...
              var res = result.row;
                    ...
                    $.each(res, function (i, item) {
                        ...
                        html += '<lable>Select Firm</lable>';
                        html +='<select class="form-control" name="bill_firm_id" onchange="get_invoice_type(bill_firm_id);">';
                            html += '<option value="">--select--</option>';
                            $.each(item.firms, function (r, fitem) {
                                html += '<option value="'+fitem.id+'">'+fitem.firm_name+'</option>';
                            });
                        html += '</select>';
                        html +='</div>';
                        html +='<div/>';

                        html+=`<div class="card display_invoice" style="display:none">`;
                        // html+=`<div class="card-header" id="heading${i}">`;
                        // html+=`<h5 class="mb-0">`;
                        // html+=`<a class="btn btn-link" data-toggle="collapse" data-target="#collapse${i}" aria-expanded="true" aria-controls="collapse${i}">
                        //        &nbsp;<span class="save_firm_text_${item.firm_id}"></span>
                        //       </a>`;
                        // html+=`</h5>`;
                        // html+=`</div>`;
                        if(i==0){
                        html+=`<div id="collapse${i}" class="collapse show save_firm_model_${item.firm_id}" aria-labelledby="heading${i}" data-parent="#accordion">`;
                        }else{
                        html+=`<div id="collapse${i}" class="collapse save_firm_model_${item.firm_id}" aria-labelledby="heading${i}" data-parent="#accordion">`;
                        }
                        ...
                        html += '<a class="theme-btn mt-1 method_btn save_firm_btn_'+item.firm_id+'"  onclick="save_invoice('+item.firm_id+',2)" style="cursor:pointer">Bill with amount</a>';
                        html += '<a class="theme-btn mt-1 method_btn save_firm_btn_'+item.firm_id+'"  onclick="save_invoice('+item.firm_id+',3)" style="cursor:pointer">Bill without amount</a>';
                        html += '<a class="theme-btn mt-1 method_btn save_firm_btn_'+item.firm_id+'"  onclick="save_invoice('+item.firm_id+',1)" style="cursor:pointer">Send via SMS</a>';
                        html += '<a class="theme-btn mt-1 method_btn save_firm_btn_'+item.firm_id+'"  onclick="save_invoice('+item.firm_id+',4)" style="cursor:pointer">Estimate with amount</a>';
                        html += '<a class="theme-btn mt-1 method_btn save_firm_btn_'+item.firm_id+'"  onclick="save_invoice('+item.firm_id+',5)" style="cursor:pointer">Estimate without amount</a>';
                        html += '</div>';
                        html += '</div>';
      ...
      if(firm_id!=''){
         $('.display_invoice').css('display','block');
      }

    }

    function save_invoice(firm_id,pay_method){
      $('#save_firm_id').val(firm_id);
      //var invoice_type = {1:"Bill with amount",2:"Bill without amount",3:"Send via SMS",4:"Estimate with amount",5:"Estimate without amount"};
      //var pm = invoice_type[pay_method];
      $('#inv_type').val(pay_method);

      if(pay_method==4 || pay_method==5){
        $('#is_estimate').val(1);
      }else{
        $('#is_estimate').val(0);
      }

      $('.saved_invoice_id').append('<input type="hidden" name="saved_firm_id['+firm_id+']" value="1">');
      var dataString = $('#quicksaleForm').serialize();
      $.ajax({
            type: "POST",
            url:'{{ url("quicksaleInvoice") }}',
            data: dataString,
            cache: false,
            dataType: "json",
            success: function(result){
                  //console.log(result);
                  if(result.status==1){
                    var saved_invoice_id = '<input type="hidden" name="saved_invoice_id['+result.firm_id+']" value="'+result.invoice_id+'">';
                    $('.saved_invoice_id').append(saved_invoice_id);
                    //$('.save_firm_btn_'+result.firm_id).hide();
                    //$('.save_firm_model_'+result.firm_id).removeClass('show');
                    $('.save_firm_text_'+result.firm_id).html('Done');
                    $('.save_firm_text_'+result.firm_id).css('color','#6ee1df');
                            ...
                            <div class="modal" id="selectMainService_${r_val}">
                              <div class="modal-dialog modal-lg" id="servicegroupform" >
                                <div class="modal-content">
                                  ...
                                  <!-- Modal body -->
                                  <div class="modal-body formvisit">
                                    <div class="text-center" id="spinner_service" style="display:none">
 ...
 function  Confirm_invoice(){
      var a = confirm('Are you sure you want to confirm this');
      if(a){
          $('.confirm_btn').hide();
          $('.final_view').show();
      }else{
