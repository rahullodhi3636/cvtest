...
<body>
    <div class="page-header">
        <h1 id="heading">Invoice</h1> <button value="Print Document" type="button" onclick="myFunction()"
    ...
    <div class="ticket">
        ...
        <?php
                    ...
                    <p class="centered"> {{ ($f_name[$fi])?$f_name[$fi]:'' }} </p>
