...
<script type="text/javascript">
  ...
  function calculatecash() {
    ...
    function addServiceRow(argument) {
      ...
      html +='<input type="hidden" name="offer_id[]" id="offer_id_'+$(".servicerow").length+'" value="0">';
      html +='<input type="hidden" name="free_service[]" id="free_service_'+$(".servicerow").length+'" value="0">';
      html +='<select title="Select" required name="servicegroups_'+$(".servicerow").length+'" id="servicegroups_'+$(".servicerow").length+'" class="form-control " onchange="getServices(this.value,'+$(".servicerow").length+')" data-live-search="true">';
      ...
      html +='</div>';
      html +='<input class="form-control" name="serviceName[]" id="serviceName'+$(".servicerow").length+'" required >';
      html +='</div>';
      html += '</div>';
      html +='</div>';
      html +='<div class="col-lg-2 col-md-12 col-12">';
      ...
      html +='<span class="input-group-text"><i class="fa fa-heart-o"></i></span>';
      html += '</div>';
      html +='<select class="form-control" name="serviceStaff[]" >';
      ...
      html +='<input name="serviceQuantity[]" style="width:50px" type="text" class="form-control appendfocus" placeholder="" value="1" id="serviceQty'+$(".servicerow").length+'" onkeyup="calcutateDiscount('+$(".servicerow").length+')">';
      html +='</div>';
      html +='</div>';
      html +='<div class="col-lg-2 col-md-6 col-12">';
      html +='<div class="form-group">';
      html +='<label>Price <i class="fa fa-inr"></i></label>';
      html +='<input name="services[]"  type="hidden" id="services_'+$(".servicerow").length+'"/>';
      html +='<input name="brand[]"  type="hidden" id="brand_'+$(".servicerow").length+'"/>';
      html +='<input name="servicesSgst[]" type="hidden" id="servicesSgst'+$(".servicerow").length+'" class="sgstCount">';
      html +='<input name="servicesCgst[]" type="hidden" id="servicesCgst'+$(".servicerow").length+'" class="cgstCount">';
      html +='<input name="servicesgstdiscount[]" type="hidden" id="servicesgstdiscount'+$(".servicerow").length+'" class="gstdiscount">';
      html +='<input name="servicePriceTotal[]" type="hidden" id="servicePriceTotal'+$(".servicerow").length+'" class="countTotal">';
      html +='<input name="servicePriceActualRate[]" type="hidden" id="servicePriceActualRate'+$(".servicerow").length+'" class="">';
      html +='<input name="servicePrice[]" type="text" class="form-control" placeholder="" id="servicePrice'+$(".servicerow").length+'">';
      html +='</div>';
      html +='</div>';
      html +='<div class="col-lg-2 col-md-6 col-12">';
      html +='<div class="form-group">';
      html +='<label>Disc.</label>';
      html +='<input name="serviceDisc[]" id="serviceDisc'+$(".servicerow").length+'" type="text" class="form-control" placeholder="" value="0" onkeyup="calcutateDiscount('+$(".servicerow").length+')">';
      html +='</div>';
      html +='</div>';
      html +='<div class="col-lg-2 col-md-6 col-12">';
      html +='<div class="form-group">';
      html +='<label style="font-size:14px">Cgst/Sgst/Disc%</label>';
      html +='<input name="cgst[]" id="cgst_'+$(".servicerow").length+'" type="text" class="form-control" placeholder=""  onkeyup="calcutateDiscount('+$(".servicerow").length+')" readonly="true">';
      html +='</div>';
      html +='</div>';
      html +='<div class="col-lg-2 col-md-6 col-12">';
      html +='<div class="form-group">';
      html +='<label>Add.</label>';
      html +='<input name="serviceAdd[]" id="serviceAdd'+$(".servicerow").length+'" type="text" class="form-control" placeholder="0" value="0" onkeyup="addDiscount('+$(".servicerow").length+')">';
      html +='</div>';
      html +='</div>';
      html +='<div class="col-lg-2 col-md-6 col-12">';
      html +='<div class="form-group">';
      html +='<label>Total <i class="fa fa-inr"></i></label>';
      html +='<input name="serviceTotal[]" type="text" class="form-control totalprice" placeholder="" id="serviceTotal'+$(".servicerow").length+'">';
      html +='</div>';
      html +='</div>';
      html +='<div class="col-lg-1 col-md-6 col-12">';
      html +='<div class="form-group">';
      ...
      html +='<input value="" type="hidden" name="groupidfirm[]" id="groupidfirm_'+($(".servicerow").length+1)+'">';
