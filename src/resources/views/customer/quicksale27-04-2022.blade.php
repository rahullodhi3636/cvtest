           ...
           <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="row">
                ...
                <!--model popup for select invoice_type-->
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-primary final_view" onclick="set_Invoice_Type();checkcustomer_id();">Save changes</button>
                          {{-- <button type="button" class="btn btn-primary confirm_btn" onclick="Confirm_invoice()">Confirm</button> --}}
      ...
      if(array[i] != ""){
        $.ajax({
          ...
          success:function(res) {
            ...
            $("#groupidfirm_"+totalcount).val(res.firm_id);
            ...
            success: function(result){
              ...
              var res = result.row;
                    ...
                    $.each(res, function (i, item) {
                        ...
                        html += services;
                        html += '</div>';
                        html += '<div class="row final_view">';
                        html += '<div class="col-md-12">';
                        html += '<select name="inv_type['+item.firm_id+']" class="form-control">';
                        html += '<option value="Bill with amount">Bill with amount</option>';
                        html += '<option value="Bill without amount">Bill without amount</option>';
                        html += '<option value="Estimate with amount">Esimate with amount</option>';
                        html += '<option value="Estimate without amount">Estimate without amount</option>';
                        html += '<option value="Send via SMS">Send via SMS</option>';
                        html += '</select>';
                        html += '</div>';
                        html += '</div>';
                    });//end each
